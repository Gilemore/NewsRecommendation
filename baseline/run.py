...
if __name__ == '__main__':
    ...
    with open(Path+'/wrong/'+Prediction+'/RP_wrong.txt', 'w') as filehandle:
    ...
    with open(Path+'/wrong/'+Prediction+'/itemknn_wrong.txt', 'w') as filehandle:
      filehandle.writelines("{}\n".format(i) for i in res[2])
    ...
    sknn.fit(data)
    res = evaluation.evaluate_sessions(sknn,valid,data)
    with open(Path+'/wrong/'+Prediction+'/sknn_wrong.txt', 'w') as filehandle:
      filehandle.writelines("{}\n".format(i) for i in res[2])
